...
const vat = products.reduce(
  (acc, product) => acc + product.price * 0.12 * product.quantity,
  0
);
...
const orderContainer = document.querySelector(
  ".your-order-section .order-container"
); // Targeting the row inside the unique section
